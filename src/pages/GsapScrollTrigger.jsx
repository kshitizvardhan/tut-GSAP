...
// scrollTrigger is a pluggin, so it must be used like this
...
const GsapScrollTrigger = () => {
  ...
  useGSAP(
    () => {
      // get access to all the boxes in the scrollRef
    ...
    { scope: scrollRef }  // this way it will not when to trigger
  );
